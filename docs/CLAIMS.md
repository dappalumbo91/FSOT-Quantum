...
| Heights 16 RSA-shaped | **5/8** 64-bit × 64-bit (127-bit N) — CFRAC at locked B; 3 exhausted | `python -m fsot_quantum heights16` | `HEIGHTS16.md` |
| Heights 17 RSA-shaped | **8/8** 60-bit × 60-bit (119-bit N) ρ | `python -m fsot_quantum heights17` | `HEIGHTS17.md` |
...
| Shor / RSA | period and factor | modular + log-N (p−1/p+1/kN/ECM) + rho + CFRAC | ECM **80-bit**; RSA-shaped **81 / 95 / 103 / 111 / 119-bit**. **64-bit 5/8** CFRAC (3 miss at locked B). RSA-2048 not run. |
...
Current score is not a refusal. Factoring is far ρ **8/8**, log-N **8/8**, ECM through **80-bit**, RSA-shaped through **119-bit 8/8** (60-bit ρ), and **64-bit 5/8** CFRAC today. Three 64-bit pairs exhaust at the locked B. RSA-2048 not run. Champion MaxCut is 13–89 edges short **today**. [`HIRED_JOBS.md`](HIRED_JOBS.md).
...
| Period / factor (Shor job) | far ρ **8/8** · log-N **8/8** · ECM through **80-bit 8/8** · RSA-shaped **119-bit 8/8** · **64-bit 5/8** CFRAC | Three 64-bit pairs exhausted at locked B. RSA-2048 not run. |
