...
**First-rung ledger.** Living G17 is **3034 / 0.427%** (13 edges) — [`GSET_FAMILY.md`](GSET_FAMILY.md). Living factoring is log-N **8/8**, ECM through **80-bit**, RSA-shaped through **119-bit 8/8**. This file is the first heights run (G17 then 3016 / 31 edges).
