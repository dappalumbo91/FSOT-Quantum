...
- Period / factor is far ρ **8/8**, log-N **8/8**, ECM through **52-bit 8/8**. RSA-2048 is the smoothness / √p wall. H2 Kolos derived 0.75% written; LiH FCI not invented: [`VQE_OBJECT.md`](VQE_OBJECT.md). Known-answer bank **44/44**.
