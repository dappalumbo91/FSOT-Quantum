...
| QAOA / annealer | MaxCut / Ising | family **11/11 under 1%**; G17 champion **3047** |
...
| Heights — far factor (RSA-shaped) / G17 | far **8/8** · G17 champion **3047** | `python -m fsot_quantum heights2` | `HEIGHTS_NEXT.md` |
