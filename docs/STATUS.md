...
- Period / factor is far ρ **8/8**, log-N **8/8**, ECM through **48-bit 8/8**. RSA-2048 is the smoothness / √p wall. Known-answer bank **44/44**: [`KNOWN_QC.md`](KNOWN_QC.md). [`HIRED_JOBS.md`](HIRED_JOBS.md).
