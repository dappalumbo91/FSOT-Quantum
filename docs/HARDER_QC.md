...
|-------|---------|-----------|-----:|----|
| G1.txt | n=`800` cut=`11563` | `11624` | 0.524776324845148 | True |
| G14.txt | n=`800` cut=`3034` | `3064` | 0.97911227154047 | True |
| G22.txt | n=`2000` cut=`13245` | `13359` | 0.8533572872220974 | True |
