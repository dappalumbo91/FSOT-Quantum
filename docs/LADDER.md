...
| Hubble tension | `python -m fsot_quantum h0` | Planck Cosmology vs SH0ES Particle_Astro | required |
...
| Hubble tension | Planck Cosmology vs SH0ES Particle_Astro | Planck **1.54%** · SH0ES **0.41%** | `H0_TENSION.md` — same algebra, \(D_{\mathrm{eff}}\) 25→24 |
