...
1. Keep climbing **balanced** bit length (52 → 56-bit primes) on this pin, still seed-locked.
2. Do not call 103-bit factoring a crypto record. RSA-100 is the first named challenge on that list.
