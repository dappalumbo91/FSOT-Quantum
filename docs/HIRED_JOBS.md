...
| QAOA / annealer | MaxCut / Ising | fold + KL + 2-opt + BFS / spectral + BLS | **11/11 Gset under 1%** of published champion | Aspiration met. **Champions unmatched** (G17 10 edges, G22 89, G1 39). |
...
2. **QAOA’s end-job** — Gset MaxCut vs published champions. Family 11/11 under 1%. G17 **10 edges** and G22 **89 edges** are the leftovers. BLS moved G14/G16 to 6. Not crawled.
