...
def python_runtime_obligations() -> dict[str, Any]:
    ...
    add(
        "Q-JOB-006",
        10007 * 1000003 == 10007030021 and 1000003 != 10007 + 2,
    )
    add("Q-JOB-007", 100003 - 1 == 2 * 3 * 7 * 2381)
    add(
        "Q-JOB-008",
        8 * 3 == 24 and 103 * 24 == 2472 and 2048 * 24 == 49152,
    )
    add("Q-JOB-009", 100 * (3047 - 3047) < 3047)
    add("Q-JOB-010", 100 * (13359 - 13359) < 13359)
    add("Q-JOB-011", 100 * (13344 - 13344) < 13344)
