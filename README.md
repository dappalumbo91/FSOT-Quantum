...
**Still open, written as open:** G1 39 unmatched; vendor `BR_H_gg` field still stale (fold already matches YR4). RSA-2048 not run. G14–G17 G22 G23 champions. Exclusive 0.0398 and SH0ES 6.30% were wrong objects — see [`docs/CLAIMS.md`](docs/CLAIMS.md). 64-bit RSA-shaped is **8/8**.
