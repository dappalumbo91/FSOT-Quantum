...
**Still open, written as open:** RSA-100 (330-bit) is the next named climb; RSA-2048 not run. Vendor `BR_H_gg` field still stale (fold already matches YR4). Gset unweighted **11/11 champions**. Exclusive 0.0398 and SH0ES 6.30% were wrong objects — see [`docs/CLAIMS.md`](docs/CLAIMS.md).
