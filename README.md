...
**Picked up (2026-08-17):** open objects scored as different measurements (`docs/OPEN_OBJECTS.md`). Gset family extended to G14–G17 — **10/11 under 1%**, G17 **1.017%** written not crawled. Exclusive \(\lvert V_{cb}\rvert\) is the same algebra on High_Energy_Physics (1.1σ) — `docs/V_CB_PUZZLE.md`.
