...
lemma g22_under_one_pct: "100 * ((13359::nat) - 13359) < 13359"
  by simp

lemma g23_under_one_pct: "100 * ((13344::nat) - 13344) < 13344"
  by simp
...
lemma living_jobs_surface:
  "(10007::nat) * 1000003 = 10007030021
   ...
   \<and> (119::nat) * 24 = 2856
   \<and> 100 * ((3047::nat) - 3047) < 3047
   \<and> 100 * ((13359::nat) - 13359) < 13359
   \<and> 100 * ((13344::nat) - 13344) < 13344"
  by simp
