...
def build_organ() -> dict[str, Any]:
    ...
    return {
        ...
        "hired_jobs": [
            {
                ...
                "score": "119-bit 8/8 (60-bit rho); 64-bit 8/8 CFRAC+rho",
                "command": "python -m fsot_quantum heights17",
            },
            {
                "hire": "QAOA MaxCut",
                "question": "Gset unweighted MaxCut vs published BKS",
                "score": "11/11 under 1%; G17 10 short; G14 6; G22 89; G23 50",
        ...
        "wrap": {
            ...
            "gset_family": "11/11 champions (G1–G5, G14–G17, G22–G23)",
            "factor": "RSA-shaped 119-bit 8/8; 64-bit 8/8; RSA-100 miss",
            "known_qc": "44/44",
            "stamp": "FSOT_QUANTUM_MULTIPROVER_OK",
            "vcb": "inclusive 0.002%; exclusive B→D 0.15%",
            "h0": "Planck 0.024%; SH0ES 1.00% Lean BH→WH",
            "open": [
                "Gset unweighted 11/11 champions; RSA-100 miss; next RSA-129",
                "RSA-2048 not run",
