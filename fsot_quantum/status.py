...
def main() -> int:
    snap = {
        ...
        "headlines": {
            ...
            "heights13": "95-bit RSA-shaped 8/8",
            "heights14": "103-bit RSA-shaped 8/8",
            "heights15": "111-bit RSA-shaped 8/8",
            "heights16": "127-bit RSA-shaped 5/8 CFRAC; 3 exhausted",
            ...
            "open": [
                ...
                "RSA-shaped 64-bit 5/8 CFRAC; 3 exhausted at locked B",
        ...
        "jobs_current": {
            "factor_Shor": "RSA-shaped 81/95/103/111/119-bit. 64-bit 5/8 CFRAC. RSA-2048 not run",
